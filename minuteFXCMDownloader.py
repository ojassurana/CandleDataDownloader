...
StartTime = 1487019600 # Set Start Time
EndTime = 1492117200 # Set End Time
...
while EndTime-StartTime > 60:
    lst_time.append([StartTime, StartTime+(15*24*3600)])
    StartTime = StartTime+(15*24*3600)+60
lst_time[-1][-1] = EndTime

for currency in pairs:
    all_data = []
    for i in lst_time:
        data = con.get_candles(currency, period='m1', start=datetime.datetime.fromtimestamp(i[0]), end=datetime.datetime.fromtimestamp(i[1]))
